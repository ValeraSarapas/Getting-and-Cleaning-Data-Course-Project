...
#Run R Script
1. Open RStudio and set your local directory as your working directory using  setwd()  function. 
2. Save  run_analysis.R  in the working directory and run it using  source("run_analysis.R") .
3. A new file called  tidydata.txt  will be generated in your working directory
